process SUMMARY {
    ...
    echo "${prefix}\t${rsv_type}\t\${raw_reads}\t\${trimmed_reads}\t\${pct_reads_trimmed}\t\${mapped_reads}\t\${pct_reads_mapped}\t\${pct_genome_covered}\t\${mean_genome_coverage}\t\${pct_fusion_covered}\t\${mean_fusion_coverage}\t\${pct_fusion_50x}\t\${pct_fusion_100x}\t\${consensus_length}\t\${num_ns_consensus}\t\${num_non_ns_ambiguous}" >> ${prefix}.summary.tsv
